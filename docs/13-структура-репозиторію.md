...
5. **Далі** — валідатор, повний M/ETHANE у чернетці, рецензія draft K3/K4, QR/handover polish.  
   **Зроблено / в роботі:** локальний журнал однієї події + локальні пуші I 24/48 (`UNUserNotificationCenter`).
