...
SwiftUI-клієнт у `ZeroEchelon/` читає `graph.json` і показує будь-який вузол одним каркасом. Медична логіка лише в графі.
...
Канон: `ZeroEchelon/ZeroEchelon.xcodeproj`. Папки `ios/` більше немає.
